...
try{
  ...
  */
  if((new String(Request("contentid"))) != 'undefined'){
    var content = new Content(parseInt(new String(Request("contentid"))));
    var inst = content.getActiveInstance();
    var _out = content.getActiveInstance().getContent();
    var contentObj = {};
    var contentInstObj = {};
    for(p in content){
    ...
    contentObj["activeInstance"] =  contentInstObj;
    //showObject( contentObj); 
    //Response.Write("*********************************<br />");
    //showObject( contentInstObj); 
    //Response.Write(new String(Request("format")));    
    switch((new String(Request("format"))+"")){
